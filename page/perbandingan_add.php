<?php
$Kode = $_GET['Kode'] ? $_GET['Kode'] :  $_GET['Kode'];
...
<table class="table table-striped blue">
  <tr>
    <td colspan="2"><h1><b>Pilih Objek Perbandingan</b>
      <form class="navbar-search pull-right"  method="POST" action="?page=Perbandingan-Hasil">
        <input type="hidden" name="Kode" value="<?php echo $Kode;?>">
        <button type="submit" class="btn btn-info"><i class="icon-forward"></i>Proses</button>
