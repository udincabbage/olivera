...
include_once "tahun-pasaran_config.php"; 
if($_GET) { 
	if(isset($_POST['btnSave'])){ 
		...
		if (count($pesanError)>=1 ){  
			...
			$myQry	= mysqli_query($koneksidb, $mySql) or die ("Gagal query insert :".getInsert($jmlField,$field,$txt)." DB: ".mysqli_error($koneksidb)); 
			if($myQry){ 
